...
class MainGUI(Frame):
    ...
    def start_screen(self):
        ...
        self.cols = 1
        self.loc = "Home"
        button = Button(self, bg="red", text="Push to Start", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: self.setupGUI())
...
>>>>>>> 6774453a900909d7c324b62136dd4788915c5ad1
    ...
    def pause_button(self, x, y, span):
        button = Button(self, bg="gray", text="Pause", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="light grey", command=lambda: self.pause())
        button.grid(row=x, column=y, sticky=N+S+E+W, pady=5, columnspan=span)

    def back_button(self, x, y, span):
        back_button = Button(self, bg="gray", text="Back", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="light grey", command=lambda: self.setupGUI())
    ...
    def countdown(self, mins, secs, x, y, span):
        ...
        timer.grid(row=x, column=y, sticky=N+S+E+W, ipadx=30, pady=5, columnspan=span)    

    def health(self, x, y, span):
        health = Label(self, text="[{}{}]".format(X*self.strikes," "*(self.maxstrikes-self.strikes)), bg="white", font=("TexGyreAdventor", 60))
        health.grid(row=x, column=y, sticky=N+S+E+W, ipadx=30, pady=5, columnspan=span)
        
    def location(self, x, y, span):
        location = Label(self, text=f"{self.loc}", bg="white", font=("TexGyreAdventor", 45))
        location.grid(row=x, column=y, sticky=N+S+E+W, ipadx=30, pady=5, columnspan=span)

    def Button1(self, x, y, span):
        button = Button(self, bg="red", text="The Button", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: self.Module_The_Button())
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    
    def Button2(self, x, y, span):
        button = Button(self, bg="red", text="Strike", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: self.strike())
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    
    def Button3(self, x, y, span):
        button = Button(self, bg="red", text="Module 3", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: print("pushed 3"))
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    
    def Button4(self, x, y, span):
        button = Button(self, bg="red", text="Module 4", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: print("pushed 4"))
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    
    def Button5(self, x, y, span):
        button = Button(self, bg="red", text="Module 5", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: print("pushed 5"))
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    
    def Button6(self, x, y, span):
        button = Button(self, bg="red", text="Module 6", font=("TexGyreAdventor", 25), borderwidth=10, activebackground="blue", command=lambda: print("pushed 6"))
        button.grid(row=x, column=y, sticky=N+S+E+W, padx=5, pady=5, columnspan=span)
    ...
    def Module_The_Button(self):
        ...
        button = Label(self, bg=button_color, text=button_label, font=("TexGyreAdventor", 25), borderwidth=10, relief="raised")
